...
### Submitting ideas
You can submit ideas for new features over on the [issue tracker](https://github.com/DawnTeamMC/DawnAPI/issues).

### Getting started for code modification
We're excited to hear that you're interested in contributing to the Dawn API!
...
If you have any questions or issues, or would just like to discuss the Dawn API development, feel free to [join us on Discord](https://discord.gg/8ksTVJu).
