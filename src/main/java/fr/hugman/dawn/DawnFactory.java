...
public final class DawnFactory {
    ...
    public static <S extends Shape> ShapeType<S> shapeType(MapCodec<S> codec) {
        return new ShapeType<>(codec);
    }

    public static <P extends ShapeProcessor> ShapeProcessorType<P> shapeProcessorType(MapCodec<P> codec) {
        return new ShapeProcessorType<>(codec);
    }

    public static <P extends TrunkPlacer> TrunkPlacerType<P> trunkPlacer(MapCodec<P> codec) {
        return new TrunkPlacerType<>(codec);
    }

    public static <P extends FoliagePlacer> FoliagePlacerType<P> foliagePlacer(MapCodec<P> codec) {
