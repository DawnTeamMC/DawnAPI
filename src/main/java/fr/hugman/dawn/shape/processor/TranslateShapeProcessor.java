...
public record TranslateShapeProcessor(FloatProvider x, FloatProvider y,
                                      FloatProvider z) implements LayerShapeProcessor {
    public static final MapCodec<TranslateShapeProcessor> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(
