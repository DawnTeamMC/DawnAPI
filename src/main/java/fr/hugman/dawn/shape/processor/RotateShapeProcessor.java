...
public record RotateShapeProcessor(FloatProvider x, FloatProvider y, FloatProvider z,
                                   boolean degrees) implements LayerShapeProcessor {
    public static final MapCodec<RotateShapeProcessor> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(
