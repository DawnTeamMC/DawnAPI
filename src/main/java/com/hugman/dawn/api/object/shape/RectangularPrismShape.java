...
public record RectangularPrismShape(FloatProvider width, FloatProvider height, FloatProvider depth) implements Shape {
	public static final Codec<RectangularPrismShape> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
			DawnCodecs.FLOAT_NON_ZERO.fieldOf("width").forGetter(RectangularPrismShape::width),
			DawnCodecs.FLOAT_NON_ZERO.fieldOf("height").forGetter(RectangularPrismShape::height),
			DawnCodecs.FLOAT_NON_ZERO.fieldOf("depth").forGetter(RectangularPrismShape::depth)
