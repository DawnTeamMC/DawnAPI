...
public class FertilizableMushroomPlantBlock extends net.minecraft.block.MushroomPlantBlock {
	...
	public FertilizableMushroomPlantBlock(Settings settings, Block hatBlock) {
		super(settings, () -> Feature.HUGE_RED_MUSHROOM.configure(new HugeMushroomFeatureConfig(BlockStateProvider.of(hatBlock.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(Blocks.MUSHROOM_STEM.getDefaultState()), 2)));
