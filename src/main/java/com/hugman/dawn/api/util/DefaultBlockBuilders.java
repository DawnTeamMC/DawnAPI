...
public final class DefaultBlockBuilders {
	...
	public static final BlockCreator.Builder MUSHROOM = new BlockCreator.Builder().provider(DawnMushroomPlantBlock::new).settings(FabricBlockSettings.of(Material.PLANT).noCollision().hardness(0.0F).sounds(BlockSoundGroup.GRASS).luminance(1)).itemGroup(ItemGroup.DECORATIONS).render(BlockCreator.Render.CUTOUT).compostingChance(0.65F);
}
