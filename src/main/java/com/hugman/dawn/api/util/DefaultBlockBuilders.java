...
public final class DefaultBlockBuilders {
	...
	public static final BlockCreator.Builder STAIRS = new BlockCreator.Builder().provider(settings -> new StairsBlock(Blocks.STONE.getDefaultState(), settings)).itemGroup(ItemGroup.BUILDING_BLOCKS);
	...
	public static final BlockCreator.Builder WOOD_BUTTON = new BlockCreator.Builder().provider(s -> new WoodenButtonBlock(s.noCollision().strength(0.5F))).settings(FabricBlockSettings.of(Material.DECORATION).noCollision().hardness(0.5F).sounds(BlockSoundGroup.WOOD)).itemGroup(ItemGroup.REDSTONE);
	...
	public static final BlockCreator.Builder MUSHROOM = new BlockCreator.Builder().provider(s -> new DawnMushroomPlantBlock(s, null)).settings(FabricBlockSettings.of(Material.PLANT).noCollision().hardness(0.0F).sounds(BlockSoundGroup.GRASS).luminance(1)).itemGroup(ItemGroup.DECORATIONS).render(BlockCreator.Render.CUTOUT).compostingChance(0.65F);
}
