...
public class DawnRegistries {
	...
	public static final SimpleRegistry<ConfiguredShape> CONFIGURED_SHAPE = FabricRegistryBuilder.createSimple(ConfiguredShape.class, Dawn.MOD_DATA.id("configured_shape")).buildAndRegister();
