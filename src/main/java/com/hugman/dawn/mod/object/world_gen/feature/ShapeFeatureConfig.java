...
public record ShapeFeatureConfig(Shape shape, BlockStateProvider state, FloatProvider yOffset) implements FeatureConfig {
	public static final Codec<ShapeFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
			Shape.TYPE_CODEC.fieldOf("shape").forGetter((config) -> config.shape),
