...
public class DawnItemGroups {
	...
	public static final ItemGroup CREATIVE_TOOLS = FabricItemGroupBuilder.create(Dawn.MOD_DATA.id("creative_tools")).icon(() -> new ItemStack(Blocks.COMMAND_BLOCK)).appendItems(itemStacks -> {
