...
public class DawnBlocks extends DawnPack {
	...
	public static final BlockCreator DUMMY2_BLOCK = register(new BlockCreator.Builder("dummy2", TrapdoorBlock::new, FabricBlockSettings.copyOf(Blocks.STONE)).build());
